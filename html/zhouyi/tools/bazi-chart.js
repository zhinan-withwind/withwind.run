...
// 显示函数
function displaySizhu(sizhu) {
    const grid = document.getElementById('sizhuGrid');
    grid.innerHTML = '';
    
    // 创建表头
    const headers = ['干神', '天干', '地支', '藏干', '星运', '自坐', '空亡', '纳音', '神煞'];
        ...
        sizhu.forEach((column, colIndex) => {
            ...
            switch(header) {
                ...
                case '地支':
                    ...
                    break;
                case '藏干':
                    value = column.hiddenStems.join(', ');
                    break;
                case '星运':
                    value = column.xingyun;
                    break;
                case '自坐':
                    value = column.zizuo;
                    break;
                case '空亡':
                    value = column.kongwang;
                    break;
                case '纳音':
                    value = column.nayin;
                    break;
                case '神煞':
                    value = column.shensha;
                    break;
            }
...
function displayDayun(dayun) {
    ...
    // 创建数据行
    const rows = ['干神', '天干', '地支', '支神', '星运', '自坐', '纳音'];
...
function displayLiunian(liunian) {
...
window.displaySizhu = displaySizhu;
window.displayDayun = displayDayun;
window.displayLiunian = displayLiunian;
window.applyElementStyle = applyElementStyle;
window.addResultAnimations = addResultAnimations;